...
/* @var $searchModel app\models\Presupuesto\PresupuestoVersionSearch */
...
?>
<div class="presupuesto-version-index">
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Crear una nueva Versión','class'=>'btn btn-default']).
