...
return [
    ...
    [
        ...
        'template'=>'{aprobar-requerimiento} {desaprobar-requerimiento} {pedido-certificacion} {update} ',
        'buttons'=>[
          'aprobar-requerimiento' => function ($url, $model) {
            if($model->situacion_requerimiento_id==5){
              return Html::a('<span class="glyphicon glyphicon-ok-circle btn-aprobar-operaciones-requerimiento "  data-id="'.$model->requerimiento_id.'"></span>', ['#'], [
          ...
          'desaprobar-requerimiento' => function ($url, $model) {
            if($model->situacion_requerimiento_id==5){
              return Html::a('<span class="glyphicon glyphicon-ban-circle btn-desaprobar-operaciones-requerimiento "  data-id="'.$model->requerimiento_id.'"></span>', ['#'], [
                      'title' => Yii::t('yii', 'Desaprobar'),'aria-label'=>"Desaprobar",'data-pjax'=>"0",'data-toggle'=>"tooltip",'data-original-title'=>"Desaprobar"
              ]);
            }
          },
          'update' => function ($url, $model) {
              return Html::a('<span class="glyphicon glyphicon-eye-open"></span>', ['update-autorizacion-operaciones-requerimiento','id'=>$model->requerimiento_id], [
