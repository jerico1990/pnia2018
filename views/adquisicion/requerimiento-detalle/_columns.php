    ...
    [
        ...
        'buttons'=>[
          'update' => function ($url, $model) {
            return Html::a('<span class="glyphicon glyphicon-pencil"></span>', ['/Adquisicion/requerimiento-detalle/update','id'=>$model->requerimiento_detalle_id], [
                    'title' => Yii::t('yii', 'Create'),'aria-label'=>"Actualizar",'data-pjax'=>"0",'role'=>"modal-remote",'data-toggle'=>"tooltip",'data-original-title'=>"Update"
            ]);
          }
        ],
        'dropdown' => false,
