...
/* @var $searchModel app\models\rrhh\StaffPersonaSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$title  = "Relación de Personas";
$this->title = Yii::t('app', 'Staff Personas');
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="staff-persona-index">
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Registrar Nuevo Personal','class'=>'btn btn-default']).
