...
$this->title = Yii::t('app', 'Lista de Contratos de Recursos Humanos');
...
<div class="contrato-contrato-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> Lista de Contratos de Recursos Humanos',
...
<div id ="lista-documentos2" style="display:none">
    <?php 
