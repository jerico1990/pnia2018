...
$this->title = 'Tramite Documentario';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="tramite-documentario-index">
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Crear nuevo tramite documentario','class'=>'btn btn-default']).
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> Tramite Documentario',
...
<div id ="lista-documentos" style="display:none">
    <?php 
