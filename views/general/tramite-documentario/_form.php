...
<div class="tramite-documentario-form">
    ...
    <?= $form->field($model, 'codigo_arbol')->dropDownList($lista_presupuestos_ramas)->label('Presupuesto Rama') ?>
    
    <?= $form->field($model, 'periodo_id')->dropDownList($array_periodo) ?>

    <?= $form->field($model, 'monto')->textInput() ?>

    <?= $form->field($model, 'ro_rooc')->dropDownList($array_ro_rooc) ?>
