...
//    ],
    [
        'class'=>'\kartik\grid\DataColumn',
        'label' => 'Fondo de Caja Chica',
        'width' => '300px',
        'attribute'=>'descripcionFondoRendicion', 
        'value' => 'fondoRendicionCajaChica.fondoFondo.motivo',
    ],
    [
        'class'=>'\kartik\grid\DataColumn',
...
//        'label' => 'Tipo Afecto',
//        'width' => '300px',
//        'attribute'=>'descripcionMetacodigoAfecto', 
//        'value' => 'tipoAfectoIgvMetacodigo.descripcion',
//    ],
    // [
        // 'class'=>'\kartik\grid\DataColumn',
    ...
    [
        ...
        'urlCreator' => function($action, $model, $key, $index) {
            //return Url::to([$action,'id'=>$key]);
            $base = Url::base();
            $text = $base."/Viatico/gestion-rendicion-caja-chica/".$action."?id=".$key;
            return $text;
        },
