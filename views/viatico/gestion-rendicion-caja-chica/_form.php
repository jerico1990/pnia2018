...
<div class="fondo-rendicion-generico-form">
    ...
    <?= $form->field($model, 'importe_caja_chica')->textInput() ?>
...
<?php
$this->registerJs("
    $('#fondorendiciongenerico-importe_caja_chica').on('change',function(){
        if($(this).val()==''){
            $('#fondorendiciongenerico-importe_gravado').val('');
             ...
             $.ajax({
                    ...
                    data: {
                        //id: $(this).val()
                        importe: $('#fondorendiciongenerico-importe_caja_chica').val(),
                    },
