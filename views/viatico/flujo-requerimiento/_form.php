...
$flujo_requerimiento_id = $model->flujo_requerimiento_id;
?>

<div class="flujo-requerimiento-form">
    ...
    <!-- s<?= $form->field($model, 'ro_rooc')->dropDownList($array_ro_rooc) ?>-->
...
<input type="button" id="btn_avanza_paso" value="Procesar">
    ...
    $(document).ready(function(){
        ...
        if("<?php echo $estado_actual ?>" == "En Digitación" || "<?php echo $estado_actual ?>" == ""){
            ...
            $('.bootstrap-switch-label').prop('disabled', 'disabled');
        ...
        if("<?php echo $estado_actual ?>" != "" && "<?php echo $estado_actual ?>" != "Desaprobado"){
            ...
            method: 'POST',
            data: {
                flujo_requerimiento_id: "<?php echo $flujo_requerimiento_id; ?>"
            },
