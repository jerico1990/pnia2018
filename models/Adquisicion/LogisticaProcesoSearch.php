...
use app\models\Adquisicion\LogisticaProceso;

/**
 * LogisticaProcesoSearch represents the model behind the search form about `app\models\Adquisicion\LogisticaProceso`.
 */
