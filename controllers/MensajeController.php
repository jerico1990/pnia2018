...
class MensajeController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if($model->load($request->post())) {
            if (!Yii::$app->user->isGuest) {
                $model->usuario_id_de = Yii::$app->user->identity->usuario_id;
            }
            $model->status = 'Enviado'; //Enciado -> leido ->/o borrado
        }
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> 'Enviado',
                    'content'=>'<span class="text-success">Mensaje Enviado</span>',
                    'footer'=> Html::button('Cerrar',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
                            Html::a('Otro Mensaje',['create'],['class'=>'btn btn-primary','role'=>'modal-remote'])
            ...
            */
            if ($model->load($request->post()) && $model->save()) {
                return $this->redirect(['view', 'id' => $model->mensaje_id]);
            } else {
    ...
    /**
     * Delete an existing Mensaje model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Mensaje model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
