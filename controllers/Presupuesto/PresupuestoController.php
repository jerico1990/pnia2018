...
//                $out = Json::encode(['output' => $output, 'message' => '']);
    ...
    public function actionView($id)
    {
        ...
        $title = "Presupuesto : ".$model->presupuestoCabecera->lineaNivel->nombre_linea . ' ' .$periodo->mes.'-'.$periodo->anho;
    ...
    public function actionUpdate($id)
    {
        ...
        $model = $this->findModel($id);
        $periodo = $model->periodo;
        $title = "Actualizar Presupuesto : ".$model->presupuestoCabecera->lineaNivel->nombre_linea . ' ' .$periodo->mes.'-'.$periodo->anho;
        $array_metacodigo_estados = Metacodigo::getComboBoxItems(Yii::$app->params['metacodigoFlags']['Estado_Presupuesto']);     
