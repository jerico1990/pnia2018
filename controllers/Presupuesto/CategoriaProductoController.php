...
use app\models\Presupuesto\CategoriaProductoSearch;
...
class CategoriaProductoController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Crear nueva Categoría/Producto",
                ...
                return [
                    ...
                    'title'=> "Crear nueva Categoría/Producto",
                    'content'=>'<span class="text-success">Categoría/Producto creada</span>',
                    'footer'=> Html::button('Cerrar',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
            ...
            */
            if ($model->load($request->post()) && $model->save()) {
                return $this->redirect(['view', 'id' => $model->categoria_producto_id]);
            } else {
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Actualizar Categoría/Producto ",
    ...
    /**
     * Delete an existing CategoriaProducto model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing CategoriaProducto model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
