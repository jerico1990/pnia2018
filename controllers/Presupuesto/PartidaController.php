...
use app\models\Presupuesto\PartidaSearch;
...
class PartidaController extends Controller
{
    ...
    {   
        ...
        $title = "Partida - ".$model->descripcion;
        if($request->isAjax){
        ...
        if($request->isAjax){
            ...
            */
            if ($model->load($request->post()) && $model->save()) {
                return $this->redirect(['view', 'id' => $model->partida_id]);
            } else {
    ...
    public function actionUpdate($id)
    {
        $request = Yii::$app->request;
        $model = $this->findModel($id);
        $title = "Actualizar Partida - ".$model->descripcion;
