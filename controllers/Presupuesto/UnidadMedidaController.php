...
use app\models\Presupuesto\UnidadMedidaSearch;
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Crear Nueva Unidad de Medida",
                    'content'=>'<span class="text-success">Unidad de Medida Creada</span>',
                    'footer'=> Html::button('Cerrar',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
            ...
            */
            if ($model->load($request->post()) && $model->save()) {
                return $this->redirect(['view', 'id' => $model->unidad_medida_id]);
            } else {
