...
use app\models\Auditoria\RolUsuarioSearch;
 ...
 */
class RolUsuarioController extends BehaviorController
{
    ...
    {   
        ...
        $title = "Rol de Usuarios #".$model->id;
        if($request->isAjax){
    ...
    /**
     * Delete an existing RolUsuario model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing RolUsuario model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
