 ...
 */
class GestionRendicionViaticoController extends BehaviorController
{
    /**
     * @inheritdoc
     */
    ...
    public function actionEnviarCodigoRendicion(){
        $_SESSION['fondo_rendicion_viatico_id'] = $_POST['fondo_rendicion_viatico_id'];
        return true;
    }
    ...
    {   
        ...
        if($request->isAjax){
            ...
            return [
                    'title'=> "Detalle de Rendición de Viático ",
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Agregar Nuevo Detalle de Rendición de Viático",
                ...
                $model->fondo_rendicion_viatico_id = $_SESSION['fondo_rendicion_viatico_id'];
                $model->save();
                return [
                    'forceReload'=>'#crud-datatable-rendicion-viatico-pjax',
                    'title'=> "Agregar Nuevo Detalle de Rendición de Viático",
                    'content'=>'<span class="text-success">Detalle de Rendición de Viático Agregado</span>',
                    'footer'=> Html::button('Cerrar',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Actualizar Detalle de Rendición de Viático ",
    ...
    public function actionDelete($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            Yii::$app->response->format = Response::FORMAT_JSON;
            return ['forceClose'=>true,'forceReload'=>'#crud-datatable-rendicion-viatico-pjax'];
        }else{
            /*
            *   Process for non-ajax request
            */
