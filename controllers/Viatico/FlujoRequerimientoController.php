 ...
 */
class FlujoRequerimientoController extends BehaviorController
{
    public function actionValidarMontoPeriodo(){
        return FlujoRequerimiento::validarMontoRequerimiento($_POST['codigo_arbol'], $_POST['periodo_id'], $_POST['ro_rooc'], $_POST['monto']);
    }

    public function actionCargarPeriodos(){
        
        return json_encode(PresupuestoCabecera::getComboBoxPeriodosDisponibles($_POST['codigo_arbol']));
    }
    ...
    public function actionCreate()
    {
        ...
        $array_flujo_flujo = FlujoFlujo::getComboBoxItemsRequerimientos();
    ...
    public function actionUpdate($id)
    {
        ...
        $title = "Procesar requerimiento: ".$model->descripcion;
        if($request->isAjax){
            /*
            *   Process for ajax request
            */
