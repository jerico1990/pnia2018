 ...
 */
class FondoRendicionGenericoController extends BehaviorController
{
    /**
     * @inheritdoc
     */
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new FondoRendicionGenerico",
                ...
                return [
                    ...
                    'title'=> "Create new FondoRendicionGenerico",
                    'content'=>'<span class="text-success">Create FondoRendicionGenerico success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update FondoRendicionGenerico #".$id,
