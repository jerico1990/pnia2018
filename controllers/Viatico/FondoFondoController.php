 ...
 */
class FondoFondoController extends BehaviorController
{
    ...
    public function actionCreate()
    {
        ...
        $lista_flujo_requerimiento = FlujoRequerimiento::getComboBoxItems(); 
            ...
            if($request->isGet){
                ...
                if($model->load($request->post()) && $model->save()){
                    return [
                        ...
                        'title'=> "Crear nuevo Fondo",
                        'content'=>'<span class="text-success">Create FondoFondo success</span>',
                        'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id)
    {
        ...
        $flujo_requerimiento = new FlujoRequerimiento();
        $lista_flujo_requerimiento = $flujo_requerimiento->getComboBoxItems(); 
