 ...
 */
class GestionRendicionEncargoController extends BehaviorController
{
    /**
     * @inheritdoc
     */

    public function actionLlenarImporteGravado($importe){
    ...
    public function actionEnviarCodigoRendicion(){
        $_SESSION['fondo_rendicion_encargo_id'] = $_POST['fondo_rendicion_encargo_id'];
        return true;
    }
    ...
    {   
        ...
        if($request->isAjax){
            ...
            return [
                    'title'=> "Detalle Rendición de Entrega #".$id,
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Agregar Nuevo Detalle de Rendición de Entrega",
                ...
                $model->fondo_rendicion_encargo_id = $_SESSION['fondo_rendicion_encargo_id'];
                $model->save();
                $model->asignarBienesServicios();
                return [
                    'forceReload'=>'#crud-datatable-rendicion-encargo-pjax',
                    'title'=> "Agregar Nuevo Detalle de Rendición de Entrega",
                    'content'=>'<span class="text-success">Detalle de Rendición de Entrega Agregado</span>',
                    'footer'=> Html::button('Cerrar',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Actualizar Detalle de Rendición de Entrega ",
                ...
                return [
                    'forceReload'=>'#crud-datatable-rendicion-encargo-pjax',
                    'title'=> "FondoRendicionGenerico #".$id,
                    'content'=>$this->renderAjax('view', [
                        'model' => $model,
                        'array_tipo_afecto' => $array_tipo_afecto,
                        'array_metacodigo_tipo_bien_servicio' => $array_metacodigo_tipo_bien_servicio,
    ...
    public function actionDelete($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            Yii::$app->response->format = Response::FORMAT_JSON;
            return ['forceClose'=>true,'forceReload'=>'#crud-datatable-rendicion-encargo-pjax'];
        }else{
            /*
            *   Process for non-ajax request
            */
