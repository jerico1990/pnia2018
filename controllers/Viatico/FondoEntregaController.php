 ...
 */
class FondoEntregaController extends BehaviorController
{
    ...
    {    
        ...
        $dataProvider = $searchModel->searchEntrega(Yii::$app->request->queryParams);
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Crear nuevo Fondo de Entrega",
                ...
                if($model->load($request->post()) && $model->save()){
                    return [
                        ...
                        'title'=> "Crear nuevo Fondo de Entrega",
                        'content'=>'<span class="text-success">Fondo de Entrega creado</span>',
                        'footer'=> Html::button('Cerrar',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id)
    {
        ...
        $model_metacodigo = $metacodigo->findById($model->tipo_flujo_metacodigo);
        $title = "Actualizar Fondo de Entrega: ".$model->motivo." - ".$model_metacodigo->descripcion;
