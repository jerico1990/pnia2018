 ...
 */
class FondoCajaChicaController extends BehaviorController
{
    ...
    {    
        ...
        $dataProvider = $searchModel->searchCajaChica(Yii::$app->request->queryParams);
            ...
            if($request->isGet){
                ...
                if($model->load($request->post()) && $model->save(false)){
                    return [
                        ...
                        'title'=> "Crear nuevo Fondo de Caja Chica",
                        'content'=>'<span class="text-success">Fondo de Caja Chica creado</span>',
                        'footer'=> Html::button('Cerrar',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id)
    {
        ...
        $metacodigo = new Metacodigo();
        $model_metacodigo = $metacodigo->findById($model->tipo_flujo_metacodigo);
        $title = "Actualizar Fondo de Caja Chica: ".$model->motivo." - ".$model_metacodigo->descripcion;
