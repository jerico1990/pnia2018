 ...
 */
class ContratoContratoRrhhController extends BehaviorController
{
    ...
    {   
        $searchModel = new ContratoContratoSearch();
        $dataProvider = $searchModel->searchContratoContratoRrhh(Yii::$app->request->queryParams);
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                ...
                $model->flg_es_staff = 'si';
                $model->save();
                $model->asignarDocumentos($array_documentos_id);
                return [
                    'forceReload'=>'#crud-datatable-pjax',
                    'title'=> "Crear Nuevo Contrato de RRHH",
                    'content'=>'<span class="text-success">Contrato de RRHH Creado</span>',
                    'footer'=> Html::button('Cerrar',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
